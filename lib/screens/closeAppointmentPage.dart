                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      if (appointmentDate != null &&
                          ...
                          doctorSelected) {
                        basicNavigator(
                            AppointmentTimes(appointmentDate.toString(),
                                doctor));
                        dateSelected = true;
                      } else {
                        alrtHospital(context,
                            "Clock selection cannot be started until the above selections are completed.");
                      }
                    },
                  ),
                  SizedBox(
          ...
          timeDatejoint != null) {
            SearchService()
              ...
              if (docs.docs.isEmpty) {
                ...
                _admin.closedHours.add(timeDatejoint);
              } else {
